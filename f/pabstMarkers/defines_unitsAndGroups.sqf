#define UNIT_MARKERS [ \
  ...
  ["UnitNATO_WSL_M","WSM"], \
  \
  ["UnitMAR_1PLT_CORPS", "P1M"], \
  ["UnitMAR_ASL_CORPS", "AM"], \
  ["UnitMAR_BSL_CORPS", "BM"], \
  ["UnitMAR_CSL_CORPS", "CM"], \
  ["UnitMAR_DSL_CORPS", "DM"], \
  ["UnitMAR_ESL_CORPS", "EM"], \
  ["UnitMAR_FSL_CORPS", "FM"], \
  ["UnitMAR_WSL_CORPS", "WSM"], \
  ["UnitMAR_RSL_CORPS", "REM"], \
  \
  ["UnitOPFOR_CO_M","COM"], \
  ["UnitOPFOR_DC_M","DCM"], \
  ["UnitOPFOR_ASL_M","AM"], \
