...
#define RIFLE_ATTACHMENTS "cup_acc_llm_black", "cup_optic_compm4"
#define ALT_OPTICS "cup_optic_microt1","cup_optic_microt1_low","cup_optic_eotech553_black","cup_optic_vortexrazor_uh1_black"
// GL Rifle
...
// Sniper Rifle
#define SNIPER "CUP_arifle_HK417_20"
#define SNIPER_MAG "CUP_20Rnd_762x51_HK417:10"
...
#define SPOTTER_ATTACHMENTS "cup_optic_elcan_specterdr_coyote","cup_acc_anpeq_15_top_flashlight_tan_l"
// SMG
#define SMG CARBINE
...
class rifleman {// rifleman
  uniform[] = {"MNP_CombatUniform_NOR_A", "MNP_CombatUniform_NOR_B"};
  vest[] = {"CUP_V_PMC_CIRAS_Khaki_Patrol"};
  headgear[] = {"CUP_H_OpsCore_Tan", "CUP_H_OpsCore_Tan_NoHS"};
...
class ftl: rifleman {// FTL
  vest[] = {"CUP_V_PMC_CIRAS_Khaki_Grenadier"};
  weapons[] = {GLRIFLE};
...
class ar: rifleman {// AR
  vest[] = {"CUP_V_PMC_CIRAS_Khaki_Veh"};
  weapons[] = {AR};
