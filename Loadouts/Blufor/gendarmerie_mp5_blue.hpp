...
#define CAMO_HEADGEAR "CUP_H_Ger_M92_Black","CUP_H_Ger_M92_Black_GG","CUP_H_Ger_M92_Black_GG_CB","CUP_H_Ger_M92_Black_GG_CF"
#define CAMO_HEADGEAR_SPECIAL "H_MilCap_gen_F"
// Pilot Camo set
...
#define RIFLE_MAG "CUP_30Rnd_9x19_MP5:10"
#define RIFLE_ATTACHMENTS "CUP_muzzle_fh_MP5", "CUP_acc_Flashlight_MP5", "CUP_optic_MicroT1_low"
#define AAR_ATTACHMENTS RIFLE_ATTACHMENTS
#define ALT_OPTICS "hlc_optic_docterr","cup_optic_ac11704_black","cup_optic_zeisszpoint","CUP_optic_MRad"
// GL Rifle
#define GLRIFLE 
#define GLRIFLE_MAG 
...
// Carbine
#define CARBINE "CUP_sgun_Saiga12K_top_rail"
#define CARBINE_MAG "CUP_5Rnd_B_Saiga12_Buck_00:10","CUP_5Rnd_B_Saiga12_Slug:5"
// AR
...
#define SPOTTER_ATTACHMENTS "acc_flashlight"
// SMG
...
// Grenades
#define POLICE_GRENADES "ACE_CTS9:2","SmokeShell:2"
...
class rifleman {// rifleman
  ...
  weapons[] = {RIFLE};
  handguns[] = {MELEE};
  magazines[] = {RIFLE_MAG,POLICE_GRENADES};
  items[] = {TOOLS};
  linkedItems[] = {LINKED};
...
class Fic_Soldier_Carbine: rifleman {// carbine-man
  weapons[] = {CARBINE};
  magazines[] = {CARBINE_MAG,POLICE_GRENADES};
};
...
class ar: rifleman {// AR
  ...
  weapons[] = {AR};
  magazines[] = {AR_MAG,POLICE_GRENADES};
};
...
class fac: coy {// FAC
  magazines[] = {RIFLE_MAG,SIDE_FAC_GRENADES,"Laserbatteries",PISTOL_MAG};
