...
#define RIFLE_MAG "potato_magazine_762x51_20rnd:11","potato_magazine_762x51_20rnd_tracer_Red:4"
...
#define SNIPER_MAG "potato_magazine_50_bmg_10rnd:7","potato_magazine_50_bmg_10rnd_tracer_Red:3"
...
class ftl: rifleman {// FTL
  weapons[] = {GLRIFLE};
  headgear[] = {"CUP_H_LWHv2_OD_ess_comms"};
