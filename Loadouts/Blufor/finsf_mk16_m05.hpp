...
#define SNIPER_OPTIC "CUP_acc_ANPEQ_15_Black", "hlc_optic_ATACR_Offset", "CUP_bipod_Harris_1A2_L_BLK"
// Spotter
#define SPOTTER "arifle_SPAR_03_blk_F"
#define SPOTTER_MAG "ACE_20Rnd_762x51_M118LR_Mag:10"
#define SPOTTER_OPTIC "CUP_acc_ANPEQ_15_Black", "hlc_optic_ATACR_Offset", "CUP_bipod_Harris_1A2_L_BLK"
// SMG
...
#define ARPACK "acp_FI_M05_Relish_lite_B_TacticalPack_FI_M05_Relish"
#define FTLPACK "acp_FI_M05_Relish_lite_B_AssaultPackEnhanced_FI_M05_Relish_insignia"
...
class Fic_Soldier_Carbine: rifleman {// carbine-man
  weapons[] = {CARBINE};
  magazines[] = {CARBINE_MAG,BASE_GRENADES,SIDE_CHEM_LIGHT};
};
...
class sm: Fic_Soldier_Carbine {// Medic
  vest[] = {M_VEST};
  magazines[] = {CARBINE_MAG,MEDIC_GRENADES,SIDE_CHEM_LIGHT};
  backpack[] = {MPACK};
