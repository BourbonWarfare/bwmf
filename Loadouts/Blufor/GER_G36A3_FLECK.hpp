...
// Camo set
#define CAMO_UNIFORM "CUP_U_B_GER_Flecktarn_2","CUP_U_B_GER_Flecktarn_3"
...
#define CAMO_HEADGEAR "CUP_H_Ger_M92_Cover","CUP_H_Ger_M92_Cover_GG_CB","CUP_H_Ger_M92_Cover_GG_CF","CUP_H_Ger_M92_Cover_GG"
...
class coy: sl {// CO and DC
  items[] += {RADIO_LR};
  vest[] = {"CUP_V_B_GER_PVest_Fleck_OFC"};
};
class uav: rifleman {
