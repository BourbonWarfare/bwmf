...
class blu_f {
	...
	#define BASE_TOOLS "ACRE_PRC343","ACE_MapTools","ACE_IR_Strobe_item","ACE_earplugs"
	#define LEADER_TOOLS "ACE_microDAGR","ACE_key_west"
	#define BASE_LINKED "ItemMap","ItemCompass","ItemWatch","rhsusf_ANPVS_14"
	#define LEADER_LINKED "ItemGPS"
	// GRENADES
	#define BASE_FRAG "rhs_mag_m67:2"
	#define BASE_GRENADES BASE_FRAG,"SmokeShell:2"
	#define LEADER_GRENADES BASE_FRAG,"SmokeShell:4","SmokeShellGreen:2","Chemlight_blue:2"
    ...
    class B_Soldier_F {// rifleman
        ...
        handguns[] = {}; /// randomized
        magazines[] = {WEST_RIFLE_MAG,BASE_GRENADES};
        items[] = {BASE_TOOLS};
	...
	class Fic_Soldier_Carbine: B_Soldier_F {// carbine-man
        ...
        magazines[] = {WEST_CARBINE_MAG,BASE_GRENADES};
    };
	class B_Soldier_TL_F: B_Soldier_F {// FTL
        ...
        magazines[] = {WEST_GLRIFLE_MAG,WEST_GLRIFLE_MAG_HE,WEST_GLRIFLE_MAG_SMOKE,LEADER_GRENADES};
        items[] += {LEADER_TOOLS};
        linkedItems[] += {LEADER_LINKED,"Binocular"};
    };
	class B_Soldier_SL_F: B_Soldier_TL_F {// SL
		headgear[] = {"rhsusf_ach_helmet_headset_ucp"}; /// randomized
		handguns[] = {WEST_PISTOL}; /// randomized
		magazines[] += {WEST_PISTOL_MAG};
        linkedItems[] = {BASE_LINKED,LEADER_LINKED,"ACE_Vector"};
        items[] += {"ACRE_PRC148"};
    };
    ...
    class B_Soldier_AR_F: B_Soldier_F {// AR
        ...
        weapons[] = {WEST_AR};
        magazines[] = {WEST_AR_MAG,WEST_PISTOL_MAG,BASE_GRENADES};
        handguns[] = {WEST_PISTOL}; /// randomized
    };
    ...
    class B_support_MG_F: B_Soldier_F {// MMG
        weapons[] = {WEST_MMG};
        magazines[] = {WEST_MMG_MAG,WEST_PISTOL_MAG,BASE_GRENADES};
        handguns[] = {WEST_PISTOL}; /// randomized
        attachments[] = {};
    };
    ...
    class B_support_Mort_F: Fic_Soldier_Carbine {// Mortar Gunner
        items[] += {BASE_MEDICAL,"ACE_RangeTable_82mm"};
    ...
    class B_spotter_F {// Spotter
        ...
        magazines[] = {WEST_SPOTTER_MAG,BASE_GRENADES};
        items[] = {BASE_MEDICAL,BASE_TOOLS,"ACRE_PRC148","ACE_ATragMX","ACE_Kestrel4500","ACE_RangeCard"};
        linkedItems[] = {BASE_LINKED,"ACE_Vector"};
        attachments[] = {WEST_RIFLE_ATTACHMENTS};
		backpack[] = {"rhsusf_assault_eagleaiii_ucp"};
    };
    class B_sniper_F: B_spotter_F {// Sniper
        weapons[] = {WEST_SNIPER}; /// randomized
        magazines[] = {WEST_SNIPER_MAG,BASE_GRENADES};
    ...
    class B_Helipilot_F {// Pilot
        ...
        items[] = {BASE_MEDICAL,BASE_TOOLS,"ACRE_PRC148"};
    ...
    class B_crew_F {// Crew
        ...
        items[] = {BASE_MEDICAL,BASE_TOOLS};
        backpackItems[] = {"ACE_key_west","ACRE_PRC117F"};
        linkedItems[] = {BASE_LINKED,LEADER_LINKED,"Binocular"};
		attachments[] = {WEST_RIFLE_ATTACHMENTS};
    };
    ...
    class B_engineer_F: B_soldier_exp_F {// Mine Specialist
        magazines[] = {WEST_CARBINE_MAG,CREW_GRENADES,"ATMine_Range_Mag:2","APERSBoundingMine_Range_Mag:2","APERSMine_Range_Mag:2"};
    };
