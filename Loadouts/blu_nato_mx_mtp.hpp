//Author: Shanahan
//Description: NATO [US Army]: MX - Tan/Green (MTP)
...
class blu_f {
  ...
  // Spotter Rifle
  #define WEST_SPOTTER WEST_CARBINE
  ...
  class B_soldier_AT_F: Fic_Soldier_Carbine {// MAT Gunner
    LAUNCHER_GEAR("B_Carryall_mcamo", RPG32_MAT_MAG)
    launchers[] = {WEST_VMAT};
  };
  class B_Soldier_AAT_F: Fic_Spotter {// MAT Spotter/Ammo Bearer
    LAUNCHER_GEAR("B_Carryall_mcamo", RPG32_MAT_MAG2)
  };
