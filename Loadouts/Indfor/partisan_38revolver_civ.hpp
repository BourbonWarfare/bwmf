...
// Camo set
#define CAMO_UNIFORM "CUP_U_C_Woodlander_01","CUP_U_C_Woodlander_04","CUP_U_C_racketeer_02","CUP_U_C_Citizen_02","CUP_U_C_Citizen_01"
...
#define CAMO_HEADGEAR "CUP_H_C_Beret_01","CUP_H_C_Beret_04","vn_o_pl_cap_01_01","CUP_H_C_Ushanka_04","CUP_H_C_Ushanka_03"
#define CAMO_HEADGEAR_SPECIAL "rhs_ssh60"
// Pilot Camo set
...
#define ALT_OPTICS "rhs_acc_ekp8_02b"
// GL Rifle
...
#define MAT_MAG "CUP_PG7VM_M:4","rhs_rpg7_type69_airburst_mag:2"
...
#define SPOTTER_ATTACHMENTS "vn_b_type56"
// SMG
#define SMG "vn_vz61"
#define SMG_MAG "vn_vz61_mag:8"
// Pistol
#define PISTOL "vn_m10"
#define PISTOL_MAG "vn_m10_mag:10"
#define PISTOL_ATTACHMENTS 
// Pistol 2
#define PISTOL_2 "vn_p38s"
// Grenades
#define LEADER_GRENADES BASE_FRAG,LEADER_SMOKES,SIDE_CHEM_LIGHT,SIDE_CHEM_LIGHT
// Gear
#define TOOLS BASE_TOOLS,"ACE_wirecutter"
#define LEADER_TOOLS BASE_LEADER_TOOLS,SIDE_KEY,"ACE_M26_Clacker"
...
#define CAMO_BACKPACK_AR "vn_b_pack_p08_02"
#define CAMO_BACKPACK_FTL CAMO_BACKPACK
#define CAMO_BACKPACK_MEDIC "cwr3_b_backpack_m5_medic_empty"
...
class rifleman {// rifleman
  ...
  handguns[] = {PISTOL, PISTOL_2};
  magazines[] = {PISTOL_MAG,BASE_GRENADES,"SatchelCharge_Remote_Mag"};
  items[] = {TOOLS};
  linkedItems[] = {LINKED};
};
...
class ftl: rifleman {// FTL
  ...
  handguns[] = {PISTOL, PISTOL_2};
  magazines[] = {PISTOL_MAG,LEADER_GRENADES,"SatchelCharge_Remote_Mag"};
  items[] += {LEADER_TOOLS};
  linkedItems[] += {LEADER_LINKED,"Old_Camera_Color_HUD"};
};
class sl: ftl {// SL
  vest[] = {CAMO_VEST_SL};
  backpack[] = {CARRYALL};
  handguns[] = {PISTOL, PISTOL_2};
  linkedItems[] = {LINKED,LEADER_LINKED,"Old_Camera_Color_HUD"};
  items[] += {RADIO_MR};
};
...
class ar: rifleman {// AR
  ...
  handguns[] = {"CUP_hgun_TEC9_FA"};
  magazines[] = {"CUP_32Rnd_9x19_TEC9:10",BASE_GRENADES,"SatchelCharge_Remote_Mag"};
};
class aar: rifleman {// AAR
  backpack[] = {CAMO_BACKPACK_AR};
  backpackItems[] += {AR_MAG};
  linkedItems[] += {"Old_Camera_Color_HUD"};
};
