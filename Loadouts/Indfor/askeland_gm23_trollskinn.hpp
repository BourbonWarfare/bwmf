...
description = "Askeland Defense Force (ADF) c. 2023 - this loadout uses the mod Project True Viking [2.0] and recreates the fictional country's military. Includes a complete SF section.";
...
// Camo set
#define CAMO_UNIFORM "ptv_u_g3_trollwdl","ptv_u_g3_trollwdl_rs","ptv_u_g3cw_trollwdl","ptv_u_g3_wdlmix1","ptv_u_g3_wdlmix2","ptv_u_g3_wdlmix2_rs"
#define CAMO_VEST "V_thor_r_rgr","V_thor_r2_rgr","V_thor_rgr"
#define CAMO_BACKPACK "B_Battle_Belt_F"
#define CARRYALL "B_Carryall_green_F"
#define CAMO_HEADGEAR "ptv_viper_ts_cover","ptv_viper_ts_cover_gc","ptv_viper_ts_cover_g"
...
#define DMR "CUP_srifle_L129A1_w","CUP_srifle_L129A1_HG_w"
#define DMR_MAG "CUP_20Rnd_762x51_L129_M:10"
#define DMR_ATTACHMENTS "ptv_PMII_rmr_wdl","ACE_DBAL_A3_Green","ptv_1a2"
...
class pilot {// Pilot
  ...
  linkedItems[] = {LINKED,LEADER_LINKED,"CUP_NVG_GPNVG_black"};
};
