...
class opf_f {
  //Rifle
  #define EAST_RIFLE "arifle_CTAR_blk_F"
  #define EAST_RIFLE_MAG "30Rnd_580x42_Mag_F:8","30Rnd_580x42_Mag_Tracer_F:2"
  #define EAST_RIFLE_ATTACHMENTS "optic_ACO_grn","UK3CB_BAF_LLM_Flashlight_Black"
  #define EAST_AAR_ATTACHMENTS EAST_RIFLE_ATTACHMENTS
  //GL Rifle
  #define EAST_GLRIFLE "arifle_CTAR_GL_blk_F"
  ...
  #define EAST_GLRIFLE_MAG_FLARE "UGL_FlareGreen_F:2","UGL_FlareYellow_F:2"
  //Carbine
  #define EAST_CARBINE EAST_RIFLE
  #define EAST_CARBINE_MAG EAST_RIFLE_MAG
  // AR
  #define EAST_AR "arifle_CTARS_blk_F"
  #define EAST_AR_MAG "100Rnd_580x42_Mag_F:4"
  // MMG
  ...
  #define EAST_SMG_MAG "30Rnd_9x21_Mag_SMG_02:5"
  // Pistol
  ...
  class O_soldier_AT_F: Fic_Soldier_Carbine {// MAT Gunner
    LAUNCHER_GEAR("MNP_B_Carryall_PLA_Basic", EAST_MAT_MAG)
    launchers[] = {EAST_MAT};
    secondaryAttachments[] = {EAST_MAT_OPTIC};
  };
  class O_Soldier_AAT_F: Fic_Spotter {// MAT Spotter/Ammo Bearer
    LAUNCHER_GEAR("MNP_B_Carryall_PLA_Basic", EAST_MAT_MAG2)
  };
  class O_soldier_AA_F: Fic_soldier_Carbine {// SAM Gunner
    LAUNCHER_GEAR("MNP_B_Carryall_PLA_Basic", EAST_SAM_MAG)
    launchers[] = {EAST_SAM};
  };
