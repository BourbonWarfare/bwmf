...
class ind_f {
  ...
  #define IND_MAT_MAG "rhs_rpg7_PG7VR_mag:2","rhs_rpg7_PG7VL_mag:1","rhs_rpg7_OG7V_mag:1"
  #define IND_MAT_MAG2 "rhs_rpg7_PG7VR_mag:2","rhs_rpg7_OG7V_mag:1"
  #define IND_MAT_OPTIC "rhs_acc_pgo7v"
  // SAM
  ...
  class I_Soldier_SL_F: I_Soldier_TL_F {// SL
    ...
    linkedItems[] = {IND_BASE_LINKED,LEADER_LINKED,RANGE_FINDER};
    items[] += {RADIO_MR};
  };
  ...
  class I_sniper_F: I_spotter_F {// Sniper
    ...
    items[] = {BASE_TOOLS,BASE_MEDICAL,"ACE_RangeCard"};
    linkedItems[] = {IND_BASE_LINKED,LEADER_LINKED};
    attachments[] = {"rhs_acc_pso1m2"};
  };
