//Author: Soviet
//Description: British: L86 - Disruptive Woodland
...
class blu_f {
  ...
  class B_soldier_AT_F: Fic_Soldier_Carbine {// MAT Gunner
    LAUNCHER_GEAR("UK3CB_BAF_B_Carryall_DPMW", WEST_MAT_MAG)
    launchers[] = {WEST_MAT};
  ...
  class B_soldier_AA_F: Fic_Soldier_Carbine {// SAM Gunner
    LAUNCHER_GEAR("UK3CB_BAF_B_Carryall_DPMW", WEST_SAM_MAG)
    launchers[] = {WEST_SAM};
  };
  class B_Soldier_AAA_F: Fic_Spotter {// SAM Spotter/Ammo Bearer
    LAUNCHER_GEAR("UK3CB_BAF_B_Carryall_DPMW", WEST_SAM_MAG2)
  };
