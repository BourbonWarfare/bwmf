...
class soldier_AT_F: Fic_Soldier_Carbine {// MAT Gunner
  LAUNCHER_GEAR("UK3CB_BAF_B_Bergen_MTP_Rifleman_H_B", MAT_MAG)
  launchers[] = {MAT};
...
class soldier_AA_F: Fic_Soldier_Carbine {// SAM Gunner
  LAUNCHER_GEAR("UK3CB_BAF_B_Bergen_MTP_Rifleman_H_C", SAM_MAG)
  launchers[] = {SAM};
};
class Soldier_AAA_F: Fic_Spotter {// SAM Spotter/Ammo Bearer
  LAUNCHER_GEAR("UK3CB_BAF_B_Bergen_MTP_Rifleman_H_C", SAM_MAG2)
};
