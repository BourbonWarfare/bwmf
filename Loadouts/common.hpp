...
// GEAR
#define BASE_MEDICAL "ACE_elasticBandage:8","ACE_packingBandage:2","ACE_tourniquet:2","ACE_splint","potato_pkblister"
#define MEDIC_MEDICAL RADIO_MR,"ACE_elasticBandage:40","ACE_packingBandage:15","ACE_epinephrine:10","ACE_salineIV:2","ACE_salineIV_500:6","ACE_salineIV_250:6","ACE_morphine:16","ACE_tourniquet:6","ACE_splint:12","ACE_adenosine:10","potato_naloxone:3","ACE_painkillers:2"
#define PL_MEDIC_MEDICAL RADIO_MR,"ACE_elasticBandage:30","ACE_packingBandage:10","ACE_epinephrine:10","ACE_salineIV:8","ACE_salineIV_500:12","ACE_salineIV_250:4","ACE_morphine:5","ACE_tourniquet:3","ACE_splint:6","ACE_adenosine:10","potato_naloxone:6","ACE_painkillers:4"
