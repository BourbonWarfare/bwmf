...
class rhs_faction_usmc_wd {
  ...
  // AR
  #define WEST_AR "rhs_weap_m249_pip_L" // Change this
  #define WEST_AR_MAG "rhs_200rnd_556x45_M_SAW:2" // Change this
  // AT
  ...
  // Spotter Rifle
  #define WEST_SPOTTER "rhs_weap_m4a1_blockII_grip2_KAC" // Change this
  #define WEST_SPOTTER_MAG "rhs_mag_30Rnd_556x45_Mk318_Stanag:8" // Change this
  // SMG
